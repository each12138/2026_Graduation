...
option_list = [
    ...
    TestOption(name="SitDown", id=20),
    TestOption(name="Hello", id=21),
    TestOption(name="Stretch", id=22),
    TestOption(name="Wallow", id=23),
    TestOption(name="Scrape", id=24),   
    TestOption(name="FrontJump", id=25),
    TestOption(name="HandStand", id=26)
]
